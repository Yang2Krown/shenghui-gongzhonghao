...
{{
  "candidates": [
    {{
      "candidate_id": "T-001",
      "title": "14-22字标题",
      "summary": "选题展开说明：用2-3句话向【审核者】阐释这个选题打算怎么展开，便于其判断是否采用。依次讲清三件事——①展开方向：该选题将从什么角度切入、用什么结构/思路展开；②核心内容：会覆盖哪些要点、面向什么读者；③选题理由：当下为什么值得做、能给读者什么价值。【语气要求】这是对一个尚未动笔的选题方案的客观陈述，不是写作建议、也不是对已完成文章的复述：禁止『本文/这篇文章/作者在文中』等把文章当作已写好的措辞，也不要用『建议你/可以考虑』这类劝说口吻；统一用『该选题将…/计划围绕…/拟以…切入』这类中性陈述。写成连贯自然的一段话，不要只是重复标题。",
      "direction": "方向",
      "routine": "X.X.X 套路名",
