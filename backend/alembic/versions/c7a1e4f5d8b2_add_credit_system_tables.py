...
def upgrade() -> None:
    ...
    op.execute("""
        ...
        VALUES 
            ('300 元充值', 3000, 300, NULL, '基础兑换，1 元 = 10 积分', NULL, 1),
            ('500 元充值', 5250, 500, NULL, '多充多送，额外赠送 250 积分', '推荐', 2),
            ('1000 元充值', 11000, 1000, NULL, '高效创作，额外赠送 1000 积分', '超值', 3),
            ('2000 元充值', 24000, 2000, NULL, '最高赠送，额外赠送 4000 积分', '最高省 ¥400', 4)
    """)
