          ...
          <div v-else-if="activeChange" class="change-carousel">
            <article :key="activeChange.id" class="change-card" :class="`impact-${activeChange.impact}`" aria-live="polite">
              ...
              <div class="change-review-actions">
                <span class="change-review-label">这处判断</span>
                <div class="change-review-buttons" role="group" aria-label="修改重要性判断">
              ...
              <div class="comment-area">
                ...
                <div class="comment-compose">
                  <el-input class="comment-input" v-model="commentDrafts[activeChange.id]" maxlength="5000" placeholder="写下你对这个修改的判断、疑问或可复用经验" @keyup.ctrl.enter="addComment(activeChange)" />
                  <el-button class="comment-submit" :loading="commenting[activeChange.id]" @click="addComment(activeChange)">评论</el-button>
                </div>
              </div>
            </article>
