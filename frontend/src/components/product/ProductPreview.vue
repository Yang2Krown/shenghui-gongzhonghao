...
.course-preview { height: calc(100% - 40px); display: grid; grid-template-columns: 190px 1fr; }.course-preview aside, .creation-preview aside { padding: 24px 18px; background: #ede6db; border-right: 1px solid #ddd5c9; }.course-preview aside b { display: block; color: #312a24; font-size: 14px; }.course-preview aside small { display: block; margin: 6px 0 24px; color: #8b8176; font-size: 11px; }.course-preview aside i { display: block; margin: 0 0 13px; color: #645c54; font-size: 12px; font-style: normal; }.course-preview article { padding: 48px 52px; }.course-preview article span { color: #ba694d; font-size: 12px; font-weight: 700; letter-spacing: .08em; }.course-preview h2 { margin: 17px 0; color: #302a25; font-family: var(--serif); font-size: 33px; line-height: 1.35; }.course-preview p { max-width: 490px; color: #71685f; line-height: 1.9; }.course-lines { margin-top: 30px; }.course-lines i { display: block; height: 10px; margin: 12px 0; border-radius: 6px; background: #e2dad0; }.course-lines i:nth-child(2) { width: 87%; }.course-lines i:nth-child(3) { width: 64%; }
